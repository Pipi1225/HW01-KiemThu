...
| :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- |
| **TC01** | Kiểm tra khởi động quạt ở mức gió 1 | Nút bấm số 1 | 1. Quạt đang cắm điện và ở trạng thái tắt (Nút 0 đang lún).<br>2. Nhấn Nút 1. | Nút 1 giữ nguyên trạng thái lún (khóa), nút 0 bật lên. Cánh quạt quay với tốc độ thấp nhất. | [Điền thực tế] | Pass / Fail | [Link YouTube hoặc để trống] |
