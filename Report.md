...
Nguyên nhân của sự thất bại này là do AI không có cơ chế tự fact-checking theo thời gian thực, cũng như không có cảm quan tương tác trực tiếp với thế giới thực.

Nguyên tắc quan trọng nhất được đúc kết từ bài tập HW01 này là tư duy "Zero-Trust". AI là một công cụ giúp tạo cấu trúc (template) và gợi ý ý tưởng rất tốt, nhưng thông tin tổng hợp từ nó không bao giờ được phép xem là nguồn chân lý. Bất kỳ số liệu trích dẫn, tiêu chuẩn học thuật hay test case nào do AI sinh ra đều bắt buộc phải được con người kiểm chứng 100% thủ công.

## Mandatory Disclosure

The report formatting templates, Mermaid mindmap script, software defects summaries, and baseline test cases were initially generated by Gemini 3.1 Pro and Gemini 3.5 Flash; I reviewed and modified ISTQB mindmap logic and the 20 software defects details (fact-checking and correcting source links), added 3 physical edge cases (TC13, TC14, TC15); the entire Requirement 1, AI Bias/Hallucination in Requirement 2, physical test executions (Actual Results), video evidence, and the AI Audit Report reasoning were written entirely by me. The detailed AI Audit Report is attached as Appendix A. I confirm I did not use AI to generate any artifact listed in the prohibited category below.
...
## 1. Các AI Tools đã sử dụng
- Gemini 3.1 Pro
- Gemini 3.5 Flash

## 2. Mục đích sử dụng AI
- Hỗ trợ tạo cấu trúc layout Markdown chuẩn cho báo cáo Requirement 1, 2 và 3.
- Hoạt động như một hệ thống được kiểm thử để tạo ra các lỗi Hallucination/Bias thực tế trong phần phân tích 20 Software Defects.
- Hỗ trợ viết script Mermaid để vẽ sơ đồ tư duy (Mindmap) về ISTQB Test Process và phân quyền QA/QC.

## 3. Lời cam kết
Em xác nhận rằng Trí tuệ Nhân tạo (AI) đã được sử dụng như một công cụ hỗ trợ trong quá trình thực hiện bài tập này. 
- Toàn bộ các output của AI (bao gồm cấu trúc, sơ đồ, tóm tắt và ngày tháng năm các vụ việc, phân tích AI hallucination/biased) đều đã được em rà soát, đối chiếu với các nguồn tin cậy và điều chỉnh lại. 
- Đối với Requirement 3 (Test Physical Product), các kịch bản test cases đều do em tự tinh chỉnh lại, các thao tác thực thi vật lý và video minh chứng hoàn toàn do em tự thực hiện độc lập, không sử dụng AI tạo sinh. 
- Các lỗi logic của AI trong báo cáo (AI Audit) cũng do em tự phát hiện và phản biện.

Em xin cam kết các nội dung khai báo trên là sự thật và chịu hoàn toàn trách nhiệm trước quy định của nhà trường.
...
# Privacy & Responsible Use Checklist

- Student name: Dương Gia Huy
- Student ID: 23127052

Những mục được đánh dấu [x] dưới đây là để xác nhận việc em tuân thủ các nguyên tắc sử dụng AI có trách nhiệm:

- [x] Em cam kết không đưa bất kỳ dữ liệu cá nhân nhạy cảm, mã nguồn độc quyền của tổ chức hoặc dữ liệu bí mật nào vào prompt của AI.
- [x] Em đã kiểm tra chéo tất cả các sự kiện, số liệu và trích dẫn do AI tạo ra (xác minh lại số liệu, thông tin và ngày tháng sự kiện trong Requirement 2).
- [x] Em không sử dụng AI để tạo ra các bằng chứng giả - gồm 10 bức ảnh jobs QA/QC ở Requirement 1, hình ảnh chứa thiết bị cùng với thẻ sinh viên và các video demo thiết bị trên thực tế ở Requirement 3.
- [x] Em nhận thức được các rủi ro thiên lệch và ảo giác của AI. Em đã chủ động phân tích và chỉ ra các điểm sai lệch của AI ngay trong báo cáo của mình.
